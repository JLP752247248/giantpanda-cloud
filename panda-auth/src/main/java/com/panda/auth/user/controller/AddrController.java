...
public class AddrController {
    ...
    public int insert(@RequestBody Addr data) {
    ...
    public int insertBatch(@RequestBody Collection<Addr> dataCollection) {
    ...
    public int updateByPrimaryKey(@RequestBody Addr data) {
    ...
    public int updateByPrimaryKeySelective(@RequestBody Addr data) {
    ...
    public int updateBatch(@RequestBody Collection<Addr> dataCollection) {
    ...
    public Addr selectByPrimaryKey(@RequestParam(value = "userId") Long userId) {
    ...
    public List<Addr> selectByIdCollection(@RequestParam(value = "idCollection") Collection<Long> idCollection) {
        return service.selectByIdCollection(idCollection);
    }

    @GetMapping(value = "/listSelective")
    @ApiOperation(value = "listSelective", notes = "")
    public List<Addr> listSelective(@RequestParam(value = "query") Addr query) {
    ...
    public int add(@RequestBody Addr data) {
    ...
    public int update(@RequestBody Addr data) {
        return service.update(data);
    }

    @GetMapping(value = "/detail")
    @ApiOperation(value = "详情", notes = "")
    public Addr detail(@RequestParam(value = "userId") Long userId) {
